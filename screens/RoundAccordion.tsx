...
export default function RoundAccordion({ openState, data }: any): JSX.Element {
    ...
    return (
        <>
            {open ?
                <TouchableHighlight underlayColor="lightgrey" activeOpacity={0.6} style={styles.openCard} onPress={() => setOpen(false)}>
                    <>
                ...
                : <TouchableHighlight underlayColor="lightgrey" activeOpacity={0.6} style={styles.closedCard} onPress={() => setOpen(true)}>
                    <>
