...
export function Header({ navigation, route }: any): JSX.Element {
    ...
    return (
        <Appbar.Header style={{ backgroundColor: "#528C6E", height: 140, elevation: 0, shadowColor: "#528C6E", shadowRadius: 0, shadowOpacity: 1, shadowOffset: { width: 0, height: 0 } }}>
            ...
            <Appbar.Content titleStyle={{ fontSize: 23, fontFamily: "RobotoSlab-Regular", }} subtitleStyle={{ fontSize: 13, fontFamily: "RobotoSlab-Regular", }} title={selectedTournament.tournament_name === "" ? "Welcome" : selectedTournament.tournament_name} subtitle={userState.name} />
